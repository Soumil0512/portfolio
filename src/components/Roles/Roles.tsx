...
export default function Roles({
  ...
  return (
    ...
    >
      ...
      <p className="duration-400 sticky top-[75px] z-[1] w-full bg-primary px-4 pb-3 pt-[10px] text-2xl font-bold shadow-lg transition-[background-color] delay-150 md:mb-0 md:w-1/2 md:shadow-none">
        Roles
      </p>
